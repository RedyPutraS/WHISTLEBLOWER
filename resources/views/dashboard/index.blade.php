...
@section('content')
    <div class="content__header content__boxed overlapping mb-4">
        <div class="content__wrap text-center">
            ...
            <p class="lead">
                Selamat datang di Dashboard Whistleblower PT. Multi Nitrotama Kimia (MNK)
            </p>
        </div>
    </div>
    <div class="content__boxed">
        <div class="content__wrap">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9 py-2 border-inline">
                            ...
                            <div id="chart-monthly-report"></div>
                        </div>
                ...
                <div class="card-body py-3">
                    <div class="row">
                        @foreach ($stats as $index => $stat)
                            <div class="col-md-2 text-center py-3 @if($index+1 != count($stats)) border-inline @endif">
