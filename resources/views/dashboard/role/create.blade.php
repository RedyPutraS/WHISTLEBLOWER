                        ...
                        <div class="card-body">
                            <form action="{{ route('role.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="r_nama" id="r_nama" class="form-control" value="{{ old('r_nama') }}" required>
                                    @error('r_nama')
                                                            ...
                                                            @foreach ($privilegegroup->privilege as $privilege)
                                                                @if ($privilege->p_nama == $privilege_list->p_nama)
                                                                    <label class="custom-control custom-checkbox align-middle">
                                                                        <input type="checkbox" name="p_ids[]" class="custom-control-input" value="{{ $privilege->p_id }}">
